...
function mostra_tooltip(e,d) {
    ...
    if (d) {
        var html = "<p class=titulo_tooltip>"+d.properties.description+"</p>";
        var id_layer = acha_id(d);
    } else {
        var html = "<p class=titulo_tooltip>"+e.layer.feature.properties.description+"</p>";
